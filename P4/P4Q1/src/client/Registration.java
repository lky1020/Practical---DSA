...
public class Registration extends javax.swing.JFrame {
  private ListInterface<Runner> runnerList = new ArrList<>();
  ...
  public String formatList() {
    String outputStr = "";
        System.out.println(runnerList.getLength());
    for (int i =1; i <= runnerList.getLength(); ++i) {
      outputStr += (i) + ". " + runnerList.getEntry(i);
    }
    return outputStr;
  }
