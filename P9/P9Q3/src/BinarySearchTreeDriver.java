...
public class BinarySearchTreeDriver {
    ...
    public static void displayInOrder(BinarySearchTreeInterface tree) {
    ...
    public static void displayPreOrder(BinarySearchTreeInterface tree) {
        Iterator it = tree.getPreorderIterator();
        while (it.hasNext()) {
            System.out.print(it.next() + " ");
        }
        System.out.println("\n");
    ...
    public static void displayPostOrder(BinarySearchTreeInterface tree) {
        Iterator it = tree.getPostorderIterator();
        while (it.hasNext()) {
            System.out.print(it.next() + " ");
        }
        System.out.println("\n");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("bTree contains (Inorder): ");
        displayInOrder(bTree);
        
        System.out.println("bTree contains (Preorder): ");
        displayPreOrder(bTree);
        
        System.out.println("bTree contains (Postorder): ");
        displayPostOrder(bTree);
