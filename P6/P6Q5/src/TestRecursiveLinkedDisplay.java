...
public class TestRecursiveLinkedDisplay {
  public static void main(String[] args) {
    ...
    System.out.println("Node of fruitList: " + fruitList.getCountNodes());
    
    System.out.println("\nyearList: \n" + yearList);
    System.out.println("Node of yearList: " + yearList.getCountNodes());
    
    System.out.println("\ncourseList: \n" + courseList);
    System.out.println("Node of courseList: " + courseList.getCountNodes());
  }
}
